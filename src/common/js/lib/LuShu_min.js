...
(function() {
     ...
     * 结束运动
     * @return 无返回值.
     * @param trueStop 控制是否执行回掉函数
     * @example <b>参考示例：</b><br />
     * lushu.stop();
     */
    LuShu.prototype.stop = function(trueStop) {
        this.i = 0;
        this._fromStop = true;
        clearInterval(this._intervalFlag);
        this._clearTimeout();
        if(trueStop && this._opts.callback != null){
            this._opts.callback();
        }
    ...
    baidu.object.extend(LuShu.prototype, {
        ...
        _move: function(initPos,targetPos,effect) {
            var me = this,
                ...
                //初始坐标
                initPos1 = this._projection.lngLatToPoint(initPos),
                //获取结束点的(x,y)坐标
                targetPos1 = this._projection.lngLatToPoint(targetPos),
                //总的步长
                count = Math.round(me._getDistance(initPos1, targetPos1) / step);
            ...
            //两点之间当前帧数大于总帧数的时候，则说明已经完成移动
	            if (currentCount >= count) {
	                ...
	                me._moveNext(++me.i);
	                    ...
	                    var x = effect(initPos1.x, targetPos1.x, currentCount, count),
	                        y = effect(initPos1.y, targetPos1.y, currentCount, count),
        ...
        _moveNext: function(index) {
            ...
            if (index < this._path.length - 1) {
                ...
                // console.log('pathIndex',me._pathIndex)
                console.log('点和路径',me._pathIndex < me._pathList.length - 1)
        ...
        _againMove: function(){
            ...
            if (me.i <= len - 1) {
                ...
                me._fromPause = false;
                me._move(me.pausePos,me._path[me.i+1], me._tween.linear)
            }
        },
        /**
